...
gym.register(
    ...
    entry_point=f"{__name__}.held_scan_lidar_env:HeldScanTemporalLidarRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Mixed-Static-Pedestrian-Temporal-Lidar-Kp-Obstacle-Avoidance-Unitree-Go2-v0",
    entry_point=_PED_CROWD_ENTRY_POINT,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.kp_mixed_scenario_env_cfg:MixedTemporalLidarKpObstacleAvoidanceEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:UnitreeGo2TemporalLidarPPORunnerCfg_v0",
    },
)
...
gym.register(
    id="Isaac-Mixed-Static-Pedestrian-Temporal-Lidar-Kp-Dynamic-Obstacle-Cbf-Obstacle-Avoidance-Unitree-Go2-Play-v0",
    entry_point=_PED_CROWD_ENTRY_POINT,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="Isaac-Mixed-Static-Pedestrian-Kp-Greedy-Obstacle-Avoidance-Unitree-Go2-Play-v0",
    entry_point=_PED_CROWD_ENTRY_POINT,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.kp_mixed_scenario_env_cfg:MixedGreedyKpObstacleAvoidanceEnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:UnitreeGo2ObstacleAvoidanceNavPPORunnerCfg_v0",
    },
)
...
gym.register(
    id="Isaac-Mixed-Static-Pedestrian-Kp-Dwa-Obstacle-Avoidance-Unitree-Go2-Play-v0",
    entry_point=_PED_CROWD_ENTRY_POINT,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.kp_mixed_scenario_env_cfg:MixedDwaKpObstacleAvoidanceEnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:UnitreeGo2ObstacleAvoidanceNavPPORunnerCfg_v0",
    },
)
